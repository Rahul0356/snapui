...
import { BrowserComponentsButton } from '../ui/browser-button';
import { BrowseBlocksButton } from '../ui/browse-blocks';
import Features from '../providers/Features';

const HeroSection = () => {
  return (
    <div className='mx-auto w-full max-w-7x1 min-h-screen flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 px-4 sm:px-6 md:py-16 lg:py-20'>
...
<span className='text-sm text-zinc-500 dark:text-zinc-300 pb-3 text-start flex items-center gap-2'>
  ...
  <span className='flex items-center gap-1.5'>
    ...
    <span className='inline-flex items-center rounded-md bg-purple-50 dark:bg-purple-900/30 px-2 py-1 text-xs
